...
def login_user(username, password):
    conn = get_conn()
    c = conn.cursor()
    c.execute("SELECT id, username, name, email, photo, bio FROM users WHERE username=? AND password=?",
...
def update_profile(user_id, name, email, bio, photo_file=None):
    ...
    conn = get_conn()
    if photo_path:
        conn.execute("UPDATE users SET name=?, email=?, bio=?, photo=? WHERE id=?",
...
def auth_ui():
    cookies = None
    if COOKIE_OK:
        cookies = EncryptedCookieManager(prefix="rag_v30_skyfix_", password="kadiya_naresh_v30_sky_no_black_2024")
   ...
   .stApp {
        background: #F0F9FF;
        background-image: radial-gradient(at 15% 15%, rgba(14,165,233,0.18) 0%, transparent 45%), radial-gradient(at 85% 15%, rgba(249,115,22,0.14) 0%, transparent 45%), radial-gradient(at 20% 85%, rgba(56,189,248,0.15) 0%, transparent 45%);
...
.stApp {
    background: #F0FAFF;
    background-image: radial-gradient(ellipse 900px 600px at 12% 12%, rgba(14,165,233,0.16), transparent 58%), radial-gradient(ellipse 800px 500px at 88% 12%, rgba(249,115,22,0.12), transparent 58%), radial-gradient(ellipse 700px 600px at 18% 88%, rgba(56,189,248,0.13), transparent 58%);
    background-attachment: fixed;
}
.main {background: transparent!important;}
.block-container {background: rgba(255,255,255,0.86); backdrop-filter: blur(26px); border-radius: 26px; border: 1px solid rgba(14,165,233,0.10); box-shadow: 0 10px 40px rgba(14,165,233,0.07);}
...
.hero-pro {background: linear-gradient(135deg, #0EA5E9 0%, #38BDF8 20%, #FB923C 40%, #FBBF24 60%, #F472B6 80%, #A78BFA 100%); border-radius: 22px; padding: 26px 30px; box-shadow: 0 14px 36px rgba(14,165,233,0.20); border: 1px solid rgba(255,255,255,0.35);}
...
/* NO BLACK BUTTONS - ONLY LIGHT */
div[data-testid="stButton"] > button {background: #FFFFFF!important; border-radius: 14px!important; height: 56px!important; font-weight: 700!important; border: 1.5px solid #BAE6FD!important; color: #0F172A!important; box-shadow: 0 2px 10px rgba(14,165,233,0.06)!important;}
section.main div[data-testid="stButton"]:nth-of-type(1) button {background: linear-gradient(135deg, #E0F2FE 0%, #BAE6FD 100%)!important; color: #0C4A6E!important; border-color: #7DD3FC!important;}
section.main div[data-testid="stButton"]:nth-of-type(2) button {background: linear-gradient(135deg, #FEF3C7 0%, #FDE68A 100%)!important; color: #78350F!important; border-color: #FCD34D!important;}
section.main div[data-testid="stButton"]:nth-of-type(3) button {background: linear-gradient(135deg, #DBEAFE 0%, #BFDBFE 100%)!important; color: #1E3A8A!important; border-color: #93C5FD!important;}
section.main div[data-testid="stButton"]:nth-of-type(4) button {background: linear-gradient(135deg, #FCE7F3 0%, #FBCFE8 100%)!important; color: #831843!important; border-color: #F9A8D4!important;}
section.main div[data-testid="stButton"]:nth-of-type(5) button {background: linear-gradient(135deg, #FEF9C3 0%, #FEF08A 100%)!important; color: #713F12!important; border-color: #FDE047!important;}
section.main div[data-testid="stButton"]:nth-of-type(6) button {background: linear-gradient(135deg, #FFEDD5 0%, #FED7AA 100%)!important; color: #7C2D12!important; border-color: #FDBA74!important;}
section.main div[data-testid="stButton"]:nth-of-type(7) button {background: linear-gradient(135deg, #E0F2FE 0%, #BAE6FD 100%)!important; color: #0C4A6E!important; border-color: #7DD3FC!important;}
section.main div[data-testid="stButton"]:nth-of-type(8) button {background: linear-gradient(135deg, #CCFBF1 0%, #99F6E0 100%)!important; color: #134E4A!important; border-color: #5EEAD4!important;}
section.main div[data-testid="stButton"]:nth-of-type(9) button {background: linear-gradient(135deg, #E0E7FF 0%, #C7D2FE 100%)!important; color: #312E81!important; border-color: #A5B4FC!important;}
section.main div[data-testid="stButton"]:nth-of-type(10) button {background: linear-gradient(135deg, #FEF3C7 0%, #FFEDD5 100%)!important; color: #78350F!important; border-color: #FCD34D!important;}
section.main div[data-testid="stButton"]:nth-of-type(11) button {background: linear-gradient(135deg, #F0F9FF 0%, #E0F2FE 100%)!important; color: #0C4A6E!important; border-color: #BAE6FD!important;}
section.main div[data-testid="stButton"]:nth-of-type(12) button {background: linear-gradient(135deg, #FFF7ED 0%, #FFEDD5 100%)!important; color: #7C2D12!important; border-color: #FDBA74!important;}
div[data-testid="stButton"] > button:hover {transform: translateY(-4px)!important; box-shadow: 0 10px 28px rgba(14,165,233,0.18)!important; filter: brightness(0.96)!important;}
...
<div class="dev-badge">🌤️ V30 SKY BLUE - SYNTAX FIXED | KADIYA NARESH</div>
""", unsafe_allow_html=True)
