...
# ========== IMAGE TO PDF / DOCX - FIXED VERSION ==========
def images_to_pdf(image_files):
    """
    FIXED: Streamlit UploadedFile ko sahi se handle karta hai
    """
    pil_images = []
    for img_file in image_files:
        # Streamlit file ko bytes me read karo
        try:
            # File pointer reset
            img_file.seek(0)
...
def images_to_docx(image_files):
    ...
    for idx, img_file in enumerate(image_files):
        ...
        # PNG me save karo quality ke liye
