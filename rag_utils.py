...
# ========== IMAGE TO PDF / DOCX - NEW GAME CHANGER FEATURE ==========
def images_to_pdf(image_files):
    """
    Single or Multiple images -> PDF converter
    Multiple images ka ek hi PDF banega, single ka single page
    """
...
def images_to_docx(image_files):
    """
    Single or Multiple images -> DOCX converter
    Har image ek page pe jayegi with proper formatting
    """
    doc = Document()
